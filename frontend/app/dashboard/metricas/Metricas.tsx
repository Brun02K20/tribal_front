...
export default function Metricas() {
  ...
  if (loading) {
    return (
      <AdminShell title="Metricas" subtitle="Auditoria, usuarios y actividad de busqueda.">
  ...
  return (
    <AdminShell title="Metricas" subtitle="Auditoria, usuarios y actividad de busqueda.">
      ...
      <section className="grid grid-cols-1 gap-3 md:grid-cols-3">
        <article className="app-panel p-4">
          <p className="app-subtitle text-sm">Usuarios registrados</p>
          <p className="app-title mt-2 text-2xl">{usuarios.totalItems}</p>
        </article>
        <article className="app-panel p-4">
        ...
        <article className="app-panel p-4">
          <p className="app-subtitle text-sm">Productos con visitas</p>
          <p className="app-title mt-2 text-2xl">{metricas.auditoria.productosMasVistos.length}</p>
        </article>
      </section>
