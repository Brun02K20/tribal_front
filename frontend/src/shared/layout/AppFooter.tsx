...
export default function AppFooter() {
  return (
    <footer className="app-footer-shared border-t border-earth-brown/70 bg-transparent px-4 py-6 text-center">
      <div className="relative z-10 mx-auto flex w-full max-w-360 flex-col items-center gap-4">
